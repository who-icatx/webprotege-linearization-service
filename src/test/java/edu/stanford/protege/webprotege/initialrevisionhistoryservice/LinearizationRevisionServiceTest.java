...
class LinearizationRevisionServiceTest {
    ...
    void getExistingHistoryOrderedByRevision() {
        ...
        when(linearizationRevisionRepo.getExistingHistory(entityIri.toString(), projectId)).thenReturn(unsortedHistory);

        // Call the method to be tested
        EntityLinearizationHistory sortedHistory = linearizationRevisionService.getExistingHistoryOrderedByRevision(entityIri.toString(), projectId);
